    ...
    <div>
      <div className="max-w-5xl mt-[60px] max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          <div className="bg-teal-500 rounded-lg p-6 h-full max-lg:order-1">
            <h2 className="text-xl text-white">Contact Information</h2>
            <p className="text-sm text-teal-900 mt-4">
              Have some big idea or brand to develop and need help?
            </p>
            ...
            <ul className="mt-16 space-y-8">
              <li className="flex items-center">
                ...
                <a
                  ...
                  className="text-white text-sm hover:text-gray-500 ml-4"
                >
              ...
              <li className="flex items-center">
                ...
                <a
                  href="https://www.google.com/maps/place/Mongolian+Temple/@24.6920375,84.9797653,695m/data=!3m2!1e3!4b1!4m6!3m5!1s0x39f32c5871b13e7f:0xfecf8cea6131cbbe!8m2!3d24.6920326!4d84.9823402!16s%2Fg%2F11c5h2y84s?entry=ttu&g_ep=EgoyMDI0MTEyNC4xIKXMDSoASAFQAw%3D%3D"
                  className="text-white text-sm hover:text-gray-500 ml-4"
                >
                  Near Mangoliya Temple Bodhgaya, Bihar
                </a>
              </li>
            </ul>

            <ul className="flex flex-wrap gap-4 mt-16">
              <li className="bg-teal-800 hover:bg-teal-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://linkedin.com/in/sunny-raj-7b9bb2243">
                  <svg
                    className="w-6 h-6 text-white dark:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
